...
mean_fish_biomass_plot <- ggplot(data = avg_biomass_per_year, aes(x = year, 
                                                                  y = mean_biomass, 
                                                                  fill = "coral")) +
...
Outbreak", size = 3, colour = "black", alpha = .8) +
  ...
  subtitle = "Moorea, French Polynesia (2006-2021)",
  caption = "Figure 3: Annual mean biomass of herbivorous reef fish from 2006–2021 (coral-pink bars), based on 
